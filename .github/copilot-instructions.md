# FerrumKV — GitHub Copilot Instructions

> The canonical AI collaboration rules for this project live in
> [`CLAUDE.md`](../CLAUDE.md). Read that file in full before making any
> changes. It is AI-agnostic and applies to every assistant including
> Copilot.
>
...
>
> See [`CLAUDE.md`](../CLAUDE.md) for the full rationale, examples, and the
> complete hard-rules list.
